...
export default function HeroSection() {
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 py-20 scroll-snap-section">
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 glass rounded-full px-6 py-3 mb-8 hover:glass-strong transition-all duration-300 animate-fade-in-up">
          <Sparkles className="w-4 h-4 text-purple-600 dark:text-purple-400" />
          <span className="text-sm font-medium text-slate-700 dark:text-slate-300">
            Trusted by 500+ Mid-Market Companies
          </span>
        </div>
        ...
        {/* Subheadline */}
        <p className="text-xl md:text-2xl text-slate-600 dark:text-slate-300 mb-12 max-w-3xl mx-auto leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          Strategic consulting services that drive measurable growth. From strategy to execution,
          we help mid-market companies achieve breakthrough results.
        </p>
        ...
        {/* Social proof */}
        <div className="flex flex-wrap justify-center items-center gap-8 text-sm text-slate-600 dark:text-slate-400 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
          ...
          <span className="font-medium">Average 3x ROI Increase</span>
          <div className="hidden sm:block w-px h-4 bg-slate-300 dark:bg-slate-600" />
          <span className="font-medium">100% Success Rate</span>
        </div>

        {/* Dashboard preview with glassmorphism */}
        <div className="mt-16 glass-strong rounded-2xl p-2 max-w-5xl mx-auto shadow-2xl animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
          <div className="bg-white dark:bg-slate-800 rounded-xl overflow-hidden border border-slate-200 dark:border-slate-700">
            ...
            <div className="p-8">
              ...
              <div className="h-32 bg-gradient-to-br from-indigo-100 to-purple-100 dark:from-indigo-900 dark:to-purple-900 rounded-lg flex items-center justify-center">
                <span className="text-2xl font-bold gradient-text">Results Dashboard Preview</span>
              </div>
            </div>
          </div>
        </div>
